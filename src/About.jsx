  ...
  return (
    <Container text textAlign="justified" fluid>
      ...
      <p>
        ...
        extensive knowledge of programming and computer applications. Looking
        for great opportunities in full-stack development, machine learning,
        etc.
      </p>
      <p>
      ...
      <p>
        ...
        communicator with all levels of employees. I instill confidence in
        others and approach new challenges with an open mind.
      </p>
      <p>
