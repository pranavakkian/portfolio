...
function Accomplishments() {
  return (
    <Container text textAlign="justified" fluid>
      ...
      <p style={{ fontSize: "13px" }}>
        Project is based on a website for Expense Tracker using JAVAScript,
        HTML, CSS, AngularJS as front-end and JAVA, Servlet and JDBC as
        back-end. JSON was used to connect front-end and back-end. Successfully
        deployed on IBM Bluemix with ClearDB database.
      </p>
      <Divider />
      <Header as="h5">Aadhar Card Enhancement System</Header>
      <p style={{ fontSize: "13px", color: "grey" }}>May 2017</p>
      <p style={{ fontSize: "13px" }}>
        The project is to make an enhancement in current AADHAAR – CARD System
        by adding one more field in the bio-metrics i.e. DNA. Java, JDBC and
        Oracle Database is used for this project
      </p>
    </Container>
  );
}
